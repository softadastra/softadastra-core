# 🧩 core — Example project using [Vix.cpp](https://github.com/vixcpp/vix)

core is a minimal example showcasing how to build and run a C++ web application using the **Vix.cpp** framework.
